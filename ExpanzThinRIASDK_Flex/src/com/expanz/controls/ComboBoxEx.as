...
package com.expanz.controls
{
	...
	/**
	 * ComboBoxEx using fieldId binds to data publications and enums 
	 * 
	 * @author expanz
	 * 
	 */
	public class ComboBoxEx extends ComboBox implements IServerBoundControl, IEditableControl, IDataControl
	{
