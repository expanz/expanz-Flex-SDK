package com.expanz.controls.halo.tabBarClasses
{
	...
	public class ExtendedTab extends Tab
	{
		...
		public function ExtendedTab()
		{
			...
			if (this.getStyle("showCloseButton")!=false){
				setStyle("showCloseButton",true); //default to true
			}
		...
		private function handleCreationComplete(event:Event):void{
			if (this.getStyle("showCloseButton")==true){
				closeButton.move(width-16,textField.y+3);
			}
		}
		...
		override mx_internal function layoutContents(unscaledWidth:Number,unscaledHeight:Number, offset:Boolean):void{
    		...
    		if (this.getStyle("showCloseButton")==true){
    			...
    			closeButton.move(width-16,textField.y+3);
    			explicitWidth = measuredWidth+6; //+6 -> extra space for the button
    		} else {
